...
(function(ba) {
    ...
    function ga(b) {
        ...
        function w(a, b) {
            var c = a.requireModules,
                f = !1;
            if (b) b(a);
            else if (v(c, function(b) { if (b = n(m, b)) b.error = a, b.events.error && (f = !0, b.emit("error", a)) }), !f) e.onError(a)
        }
        ...
        L = {
            ...
            exports: function(a) { a.usingExports = !0; if (a.map.isDefine) return a.exports ? q[a.map.id] = a.exports : a.exports = q[a.map.id] = {} },
        ...
        Z.prototype = {
            ...
            fetch: function() {
                if (!this.fetched) {
                    ...
                    var a = this.map;
                    if (this.shim) h.makeRequire(this.map, { enableBuildCallback: !0 })(this.shim.deps || [], u(this, function() { return a.prefix ? this.callPlugin() : this.load() }));
                        ...
                        if (this.error) this.emit("error", this.error);
                            ...
                            if (!this.defining) {
                                ...
                                if (1 > this.depCount && !this.defined) {
                                    if (G(l)) {
                                        if (this.events.error && this.map.isDefine || e.onError !== ca) try { f = h.execCb(c, l, b, f) } catch (d) { a = d } else f = h.execCb(c, l, b, f);
                                        this.map.isDefine &&
            ...
            callPlugin: function() {
                ...
                s(d, "defined", u(this, function(f) {
                    ...
                    if (this.map.unnormalized) {
                        ...
                        try { e.exec(f) } catch (m) { return w(B("fromtexteval", "fromText eval for " + b + " failed: " + m, m, [b])) }
                        P && (M = !0);
                        this.depMaps.push(g);
                        h.completeLoad(d);
                        p([d], l)
            ...
            enable: function() {
                ...
                v(this.depMaps, u(this, function(a, b) {
                    ...
                    if ("string" === typeof a) {
                        ...
                        this.depMaps[b] = a;
                        if (c =
                            n(L, a.id)) { this.depExports[b] = c(this); return }
                        this.depCount += 1;
        ...
        h = {
            ...
            makeRequire: function(a, j) {
                ...
                U(g, {
                    ...
                    specified: function(b) { b = i(b, a, !1, !0).id; return t(q, b) || t(m, b) }
                });
            ...
            onScriptError: function(a) { var b = I(a); if (!p(b.id)) return w(B("scripterror", "Script error for: " + b.id, a, [b.id])) }
        };
    ...
    if ("undefined" === typeof define) {
        ...
        v(["toUrl", "undef", "defined", "specified"],
            function(b) { e[b] = function() { var c = F._; return c.require[b].apply(c, arguments) } });
        ...
        z && !s.skipDataMain && T(document.getElementsByTagName("script"), function(b) { y || (y = b.parentNode); if (I = b.getAttribute("data-main")) return r = I, s.baseUrl || (E = r.split("/"), r = E.pop(), O = E.length ? E.join("/") + "/" : "./", s.baseUrl = O), r = r.replace(Q, ""), e.jsExtRegExp.test(r) && (r = I), s.deps = s.deps ? s.deps.concat(r) : [r], !0 });
...
var BASE_URL = {
    goods: '//good-api.xubei.com/goods-api/',
    user: '//user-api.xubei.com/user-api/',
    order: '//order-server.xubei.com/',
    sell: '//www.xubei.com/',
    pay: '//pay-api.xubei.com/',
    goodsSolr: '//api.xubei.com/b/',
    org: {
        goods: '//good-api.xubei.com/good-api/',
        user: '//user-api.xubei.com/user-api/',
        order: '//order-server.xubei.com/'
    }
};
